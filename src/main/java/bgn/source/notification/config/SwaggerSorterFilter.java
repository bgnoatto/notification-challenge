...
public class SwaggerSorterFilter implements Filter {
    ...
    private static final String SORTER =
            "function(a,b){" +
            "var order={get:0,post:1,put:2,patch:3,delete:4};" +
            "var am=a.get?a.get('method'):a.method;" +
            "var bm=b.get?b.get('method'):b.method;" +
            "var ap=a.get?a.get('path'):a.path;" +
            "var bp=b.get?b.get('path'):b.path;" +
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
        ...
        String modified = original.replace(
                "SwaggerUIBundle({",
                "SwaggerUIBundle({operationsSorter:" + SORTER + ","
        );
